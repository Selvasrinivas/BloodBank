...
public interface HospitalRepository extends JpaRepository<Hospital, Integer>{
	...
	*/
	...
	@Query(value="select hp_id from hospital where hp_name=:name and hp_pincode=:pin",nativeQuery=true)
	public int getHospitalId(@Param(value="name")String name,@Param(value="pin") int pincode);
}
